...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        // Extract components of other1 and other2
        var v1x = other1.elements[0];
        var v1y = other1.elements[1];
        var v1z = other1.elements[2];

        var v2x = other2.elements[0];
        var v2y = other2.elements[1];
        var v2z = other2.elements[2];

        // Calculate cross product components
        var v3x = v1y * v2z - v1z * v2y;
        var v3y = v1z * v2x - v1x * v2z;
        var v3z = v1x * v2y - v1y * v2x;
